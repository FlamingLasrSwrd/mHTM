...
class Encoder(metaclass=ABCMeta):
    ...
    def bind_data(self, raw_data):
        ...
        The raw_data must be the current value to encode. If this a list, the
        output will be a concatenation of all encoded bits. If it is a single
        value, the output will be the encoding of just that value.
